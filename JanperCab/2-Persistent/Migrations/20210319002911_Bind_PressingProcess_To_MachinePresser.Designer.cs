...
namespace _2_Persistent.Migrations
{
    ...
    [Migration("20210319002911_Bind_PressingProcess_To_MachinePresser")]
    partial class Bind_PressingProcess_To_MachinePresser
    {
            ...
            modelBuilder.Entity("_1_Domain.DuraformProcessRouting", b =>
                {
                    ...
                    b.HasIndex("MachineId")
                        .HasName("IX_DuraformProcesses_MachineId1");
            ...
            modelBuilder.Entity("_1_Domain.DuraformProcessRouting", b =>
                {
                    b.HasOne("_1_Domain.MachineRouter", "MachineRouter")
                        ...
                        .HasForeignKey("MachineId")
                        .HasConstraintName("FK_DuraformProcesses_Machines_MachineId1")
                        .OnDelete(DeleteBehavior.Restrict);
                });
