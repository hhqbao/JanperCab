...
namespace _2_Persistent.Migrations
{
    ...
    [Migration("20201201043746_EditTable_DuraformWrapTypes_AddColumn_ICB_EDGETHICK")]
    partial class EditTable_DuraformWrapTypes_AddColumn_ICB_EDGETHICK
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_1_Domain.FaceTooling", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("FaceToolings");

                    b.HasDiscriminator<string>("Discriminator").HasValue("FaceTooling");
                });
            ...
            modelBuilder.Entity("_1_Domain.BasicFaceTooling", b =>
                {
                    b.HasBaseType("_1_Domain.FaceTooling");

                    b.HasDiscriminator().HasValue("BasicFaceTooling");
                });
